...
class CRANParser(argparse.ArgumentParser):
    ...
    def __init_cran(self):
        ...
        self.add_argument('--task_util', type=float, default=1.0, help='Task Utilization')
        self.add_argument('--core0_load', type=float, default=0.0, help='Core0 Load')
        self.add_argument('--core1_load', type=float, default=0.0, help='Core1 Load')
        self.add_argument('--reward_util', type=float, default=1.0, help='Reward of Task Allocation')
        self.add_argument('--load_diff', type=float, default=1.0, help='load_difference')
        self.add_argument('--load_max', type=float, default=1.0, help='load_max')
        self.add_argument('--load_min', type=float, default=1.0, help='load_min')
        self.add_argument('--task_num', type=int, default=1.0, help='Task Number')


    def __init_dqn(self):
        self.add_argument('--lr', type=float, default=0.2, help='learning rate for dqn')
